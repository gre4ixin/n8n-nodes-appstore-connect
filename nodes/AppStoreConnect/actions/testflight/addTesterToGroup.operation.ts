...
export const description: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				resource: ['testflight'],
				operation: ['addTesterToGroup'],
			},
		},
		description: 'The unique identifier of the beta group. Use "List Beta Groups" to retrieve it.',
	},
	{
		...
		description:
			'The unique identifier of the beta tester. Use "Create Beta Tester" to get the ID for a new tester, or "List Beta Testers" for an existing one.',
	},
];
